...
export interface TooltipProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> {
  /** Mono text, one short line. Never information required to complete the task — the hint disappears on blur/hover-out with no other trace. */
  label: string;
  side?: TooltipSide;
  children?: ReactNode;
  style?: CSSProperties;
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          font: 'var(--weight-regular) var(--text-xs)/1.3 var(--font-mono)',
